        ...
        <div className="flex flex-col h-full bg-slate-50 min-h-screen relative">
            ...
            <header className="bg-white border-b border-slate-200 px-4 md:px-6 py-6 sticky top-0 z-30">
                <div className="max-w-7xl mx-auto flex flex-col lg:flex-row lg:items-center justify-between gap-6">
                    <div>
                        <h2 className="text-2xl md:text-3xl font-black text-slate-800 tracking-tighter">Monitoreo Operativo</h2>
                        <p className="text-[10px] md:text-sm text-slate-500 font-bold uppercase tracking-widest mt-1 opacity-70">Visualización de Rondas de Seguridad</p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:flex items-center gap-3 w-full lg:w-auto">
                        ...
                        >
                            <option value="all">Mis Instalaciones</option>
            ...
            <main className="flex-1 p-4 md:p-6 max-w-7xl mx-auto w-full">
                {filteredRounds.length === 0 ? (
                    <div className="bg-white rounded-[2.5rem] p-8 md:p-16 text-center shadow-sm border border-slate-100 mt-10">
                        ...
                        <p className="text-slate-400">Ajusta los filtros o verifica si tienes sucursales asignadas.</p>
                    </div>
                ) : (
