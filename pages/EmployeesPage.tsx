...
import { Search, Plus, UserCheck, UserX, MoreHorizontal, Eye, FileSpreadsheet, Upload, Loader2, Building2 } from 'lucide-react';
import EmployeeModal from '../components/EmployeeModal';
import AddEmployeeModal from '../components/AddEmployeeModal';
import * as XLSX from 'xlsx';

const EmployeesPage: React.FC = () => {
  const { employees, sites, toggleEmployeeStatus, bulkAddEmployees, isLoading } = useAppStore();
    ...
    reader.onload = async (evt) => {
        try {
            ...
            if (newEmployees.length > 0) {
                ...
                alert(`Se procesaron ${newEmployees.length} registros. \nSe intentó asignar sucursal/empresa automáticamente basado en los nombres encontrados.`);
            } else {
                alert("No se pudieron procesar filas válidas. Verifique que el Excel tenga las columnas 'RUT' y 'NOMBRES'.");
            }
