    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-50 p-4 font-sans">
      <div className="bg-white p-8 rounded-2xl shadow-2xl w-full max-w-md space-y-8 border border-slate-100 animate-in fade-in duration-500">
        <div className="text-center">
          <div className="bg-yellow-400 w-20 h-20 rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-lg shadow-yellow-200 transform rotate-3 hover:rotate-0 transition-all duration-300">
            <ShieldCheck className="text-slate-900 w-12 h-12" />
          </div>
